...
class ComplexGCN(nn.Module):
    def __init__(self, input_dim, hidden_dim, output_dim, dropout_rate=0.5, l2_reg=1e-4):
        ...
        # L2 regularization for both convolutional layers
        #self.conv1.weight_regularizer = torch.nn.regularizer.L2Loss()
        #self.conv2.weight_regularizer = torch.nn.regularizer.L2Loss()
...
labels = labels.clone() #torch.tensor(labels, dtype=torch.float32)
