...
def plot_sub_data(sub_data, cid):
    # Features to plot
    features = ['Temp', 'Sal', 'DO_mgl', 'Turb', 'errors']
...
mainData = mainData[['datetime', 'Temp', 'Sal','DO_mgl', 'Turb']]
...
result_df[label] = normalize_and_add_count(df.copy(), label,min_series_length=50, max_gap_between_series=24)['hurricaneCount']
